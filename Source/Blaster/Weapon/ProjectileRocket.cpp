...
void AProjectileRocket::BeginPlay()
{
	...
	//Since we already have OnHit bound to the collision box on server in super begin play
	//So now we will bind all client onhit functions so we have hit events on all machines
	if (!HasAuthority())
	{
