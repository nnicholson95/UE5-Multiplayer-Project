...
protected:
	...
	UFUNCTION()
	void ReceiveDamage(AActor* DamagedActor, float Damage, const UDamageType* DamageType, class AController* IntigatorController, AActor* DamageCauser);
	// Poll for nay relevant classes and initialize our HUD
	void PollInit();
...
private:
	...
	*/
	...
	//Material instance set on the bluprint, used with the dynaimic material instance
	UPROPERTY(VisibleAnywhere, Category = "Elim")
