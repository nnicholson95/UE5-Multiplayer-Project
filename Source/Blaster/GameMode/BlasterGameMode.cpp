...
{
	//forces the gamemode to stay in the waiting to start state, allows players to fly around map
	bDelayedStart = true;
}
...
void ABlasterGameMode::PlayerEliminated(ABlasterCharacter* ElimmedCharacter, ABlasterPlayerController* VictimController, ABlasterPlayerController* AttackerController)
{
	...
	//Get Attacker/Validate else null
	ABlasterPlayerState* AttackerPlayerState = AttackerController ? Cast<ABlasterPlayerState>(AttackerController->PlayerState) : nullptr;
	//Get Victim/Validate else null
	...
	if (AttackerPlayerState && AttackerPlayerState != VictimPlayerState && BlasterGameState)
	{
		...
		//if this is true we already know the player is in the lead so just add the crown to the character
		...
		{
			//Since we add the lead characters to this then if they get removed then we know they lost the lead and remove the crown
...
/*
* This function handles the book keeping 
* 
* Removes the character from the top scoring players and performs the elim logic so the character doesn't just disappear
*/
